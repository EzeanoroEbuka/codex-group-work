...
def add_student_courses(student_id, student_new_courses):
    if check_student_has_course(student_id, student_new_courses):
        return "course already exists"
    student_courses = get_student_by_id(student_id)["student_info"].get("Courses")
    student_courses.add(student_new_courses)
    return "course added successfully"

def update_student_course(student_id, old_course, student_new_course):
    if check_student_has_course(student_id, old_course):
        student_courses = get_student_by_id(student_id)["student_info"].get("Courses")
...
add_student_courses("id","Mathematics")
